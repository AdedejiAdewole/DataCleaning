...
class MainWindow(Screen):
    ...
    def suggest(self):
        ...
        a2 = "Phosphorous = " + str(self.answers[1].strip().capitalize())
        a3 = "Potassium = " + str(self.answers[2].strip().capitalize())
        if (a1 == 'lots-of-nitrogen-fertilizer' or a1 == 'small-amount-of-nitrogen-fertilizer'):
            suggest1 = "Ammonium fertilizer should be added"
        if (a2 == 'lots-of-phosphorus-fertilizer' or a2 == 'small-amount-of-nitrogen-fertilizer'):
            suggest2 = "Phosphate fertilizer should be added"
        if (a3 == 'lots-of-potassium-fertilizer' or a3 == 'small-amount-of-potassium-fertilizer'):
            suggest3 = "Potassh fertilizer should be added"
        fertilizer = suggest1 + "\n\n" + suggest2 + "\n\n" + suggest3
        fertilizer = fertilizer.replace('-', ' ')
        result = Label(text=fertilizer)
        popupWindow = Popup(title="Fertilizer suggestion", title_align='center', content=result, size_hint=(0.5, 0.5))
        popupWindow.open()
